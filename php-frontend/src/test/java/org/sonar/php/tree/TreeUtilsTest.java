...
public class TreeUtilsTest {
  ...
  @Test
  public void test_findParentWithKind() {
    ...
    assertThat(findParentWithKind(statementTree, Tree.Kind.FUNCTION_DECLARATION)).isEqualTo(func);
    assertThat(findParentWithKind(statementTree, Tree.Kind.WHILE_STATEMENT)).isNull();
  }
